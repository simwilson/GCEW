...
int main(void)
{
	...
	while (1){
		...
		if(CURR_DIRECTION == FORWARD && GOAL_DIRECTION == FORWARD){
			...
			if(CURR_MOTOR_SPEED_LEFT > GOAL_MOTOR_SPEED_LEFT ||
			abs(GOAL_MOTOR_SPEED_LEFT - CURR_MOTOR_SPEED_LEFT) < abs(GOAL_MOTOR_SPEED_LEFT - CURR_MOTOR_SPEED_LEFT)/100){
			...
			if(CURR_MOTOR_SPEED_RIGHT > GOAL_MOTOR_SPEED_RIGHT || 
				abs(GOAL_MOTOR_SPEED_RIGHT - CURR_MOTOR_SPEED_RIGHT) < abs(GOAL_MOTOR_SPEED_RIGHT - CURR_MOTOR_SPEED_RIGHT)/100){
